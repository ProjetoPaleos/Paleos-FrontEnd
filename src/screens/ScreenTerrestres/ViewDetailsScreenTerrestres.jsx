...
export default function ViewDetailsScreenTerrestres() {
  ...
  const handleDelete = () => {
  console.log('Tentando excluir fóssil com ID:', id);

  Alert.alert(
    "Confirmar Exclusão",
    "Tem certeza que deseja excluir este fóssil?",
    [
      { text: "Cancelar", style: "cancel" },
      {
        ...
        onPress: async () => {
          try {
            console.log(`Enviando DELETE para: /terrestre/${id}`);
            const response = await api.delete(`/terrestre/${id}`);
      ...
      <View style={styles.content}>
        ...
        <View style={styles.actions}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('EditScreenTerrestres', { id })}
          >
